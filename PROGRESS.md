...
| S2-2 | Mic continuous capture + silence-timeout | 🟡 in progress | [#22](https://github.com/albadrov-del/ai-english-mentor/issues/22) | [22-mic-continuous.md](progress/22-mic-continuous.md) |
