...
| 7  | Level adaptation + session summary + prompt refinement | 🟡 in progress | [#7](https://github.com/albadrov-del/ai-english-mentor/issues/7) | [07-level-summary.md](progress/07-level-summary.md) |
