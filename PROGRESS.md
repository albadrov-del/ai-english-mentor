...
| 4  | Wire frontend to Claude (text conversation works) | 🟡 in progress | [#4](https://github.com/albadrov-del/ai-english-mentor/issues/4) | [04-wire-claude.md](progress/04-wire-claude.md) |
